...
|----|---------|-------------|-------|
| ~~FEAT-028~~ | ~~Autonomy page (DONE 2026-05-31)~~ | New user-facing Autonomy page (interactive dataset/benchmark browser). Fetches `forge-data/autonomy/datasets.json`; filter by task (VIO/SLAM, CV detection, RF), modality, and license-class (badge non-commercial datasets). Cards link to Handbook Part 6 chapters. Cross-property — full plan in `drone-integration-handbook/docs/AUTONOMY_PAGE_PLAN.md`. ~1-day effort. | 2026-05-31 |
