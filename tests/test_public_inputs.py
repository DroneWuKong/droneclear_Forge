...
class PublicInputs(unittest.TestCase):
    def test_selected_public_inputs_replace_stale_mirrors_without_exporting_private_files(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            (root/'clock_score.json').write_text('{"generated":"2026-09-18T11:41:09Z","minutes_to_midnight":35}', encoding='utf-8')
            ...
            self.assertEqual(json.loads((dest/'clock_score.json').read_text(encoding='utf-8'))['minutes_to_midnight'],35)
