"""
Base Django settings for DroneClear — shared across all environments.
"""
...
ROOT_URLCONF = 'droneclear_backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'DroneClear Components Visualizer')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'droneclear_backend.version.version_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'droneclear_backend.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'DroneClear Components Visualizer'),
]
