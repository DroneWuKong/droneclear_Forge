 ...
 * static fallback data returns HTTP 503 instead of silently presenting an old
 * score as current.
 *
 * Large event evidence supports bounded read-only projections:
    ...
    return resp(
      {
        ...
        freshness,
        action:
          'The publication gate withheld this analytic dataset. Regenerate and validate the Ai-Project intel lens cascade.',
      },
      503,
      {
        'Retry-After': '3600',
